...
import views.html.OrganisationIsEnrolledView

class OrganisationIsEnrolledControllerSpec extends SpecBase {

  "OrganisationIsEnrolled Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, routes.OrganisationIsEnrolledController.onPageLoad().url)
