...
class AddedSignatoryControllerSpec extends SpecBase {
  ...
  private val routeUrl  = AddedSignatoryController.onPageLoad(NormalMode, None).url
  private val submitUrl = AddedSignatoryController.onSubmit(NormalMode, None).url
