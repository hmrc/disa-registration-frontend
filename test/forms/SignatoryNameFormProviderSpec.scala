...
class SignatoryNameFormProviderSpec extends StringFieldBehaviours {

  val requiredKey = "signatoryName.error.required"
  val invalidKey  = "signatoryName.error.invalid"

  val form = new SignatoryNameFormProvider()()
